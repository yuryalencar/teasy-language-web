...
/*package*/ class VerifierElementListToImplement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public VerifierElementListToImplement_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_lvqxd0_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "VERIFIERS ELEMENTS:");
    editorCell.setCellId("Constant_lvqxd0_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "#START VERIFIER ELEMENTS");
    editorCell.setCellId("Constant_lvqxd0_b0");
  ...
  private static class VERIFIERSListHandler_lvqxd0_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public VERIFIERSListHandler_lvqxd0_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_lvqxd0_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(MPSColors.blue));
