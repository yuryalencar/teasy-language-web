...
/*package*/ class WaitUntilPageDoesNotContainElement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.component$ldj0;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.component$ldj0);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.component$ldj0);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.timeout$ldjv;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_j7s2xt_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
