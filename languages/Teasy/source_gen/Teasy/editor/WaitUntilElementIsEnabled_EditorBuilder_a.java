...
/*package*/ class WaitUntilElementIsEnabled_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public WaitUntilElementIsEnabled_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_uvxr84_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "WAIT UNTIL ELEMENT IS ENABLED: ");
    editorCell.setCellId("Constant_uvxr84_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.component$AN5w;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.component$AN5w);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.component$AN5w);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.timeout$AP03;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_uvxr84_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
